...
public class MybatisPlusGeneratorConfig {
    ...
    private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG=new DataSourceConfig
            .Builder("jdbc:mysql://192.168.8.132:3306/gpmall?useUnicode=true&characterEncoding=utf-8&useSSL=false","root","123456")
    ...
    public static void main(String[] args) {
        ...
        String outputDir = projectPath + "/ms-service/marking-service/src/main/java";
        // 代码生成器
        FastAutoGenerator.create(DATA_SOURCE_CONFIG).globalConfig((scanner, builder) -> {
            ...
            builder.parent("com.gupaoedu.mall.markingservice")
                    .entity("dal.model")
                    .mapper("dal.mapper")
                    .build();
            ...
            builder.enableCapitalMode()
                    .enableSkipView().addInclude(scanner("mk_panel,mk_panel_content").split(","))
                    .entityBuilder()
                    .enableLombok()

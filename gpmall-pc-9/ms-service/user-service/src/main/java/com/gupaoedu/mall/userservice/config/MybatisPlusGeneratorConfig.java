...
public class MybatisPlusGeneratorConfig {
    ...
    public static void main(String[] args) {
        ...
        String outputDir = projectPath + "/ms-service/user-service/src/main/java";
        // 代码生成器
        FastAutoGenerator.create(DATA_SOURCE_CONFIG).globalConfig((scanner, builder) -> {
            ...
            builder.parent("com.gupaoedu.mall.userservice")
                    .entity("dal.model")
                    .mapper("dal.mapper")
                    .build();
            ...
            builder.enableCapitalMode()
                    .enableSkipView().addInclude(scanner("ums_user").split(","))
                    .entityBuilder()
                    .enableLombok()
